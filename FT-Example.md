...
The Shah function (Comb) is a series of delta functions with some spacing $\Delta x$. The image below is from your WS1, and is one of the examples found in the ERA appendix on Fourier Transforms:
